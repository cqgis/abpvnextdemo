        ...
        private async Task CreateClientsAsync()
        {
            ...
            if (!webClientId.IsNullOrWhiteSpace())
            {
                ...
                await CreateClientAsync(
                    ...
                    commonScopes,
                    new[] { "hybrid" },
                    (configurationSection["demo_Web:ClientSecret"] ?? "1q2w3e*").Sha256(),
            ...
            //Console Test Client
            var consoleClientId = configurationSection["demo_App:ClientId"];
            if (!consoleClientId.IsNullOrWhiteSpace())
            {
                await CreateClientAsync(
                    ...
                    (configurationSection["demo_App:ClientSecret"] ?? "1q2w3e*").Sha256()
                );
            }
        }
